...
coda.tf <- T # currently only works in full for TRUE (using coda.samples)
system.time(M.huc <- modelRegionalTempHUC(tempDataSyncS, n.burn = 2000, n.it = 1000, n.thin = 1, nc = 3, coda = coda.tf, param.list = c("sigma",
            "B.0",
            #"B.site",
            #"rho.B.site",
            #"mu.site",
...
library(ggmcmc)
ggs.huc <- ggs(M.huc)
ggmcmc(ggs.huc, file = "ggmcmc-huc.pdf", plot = c("ggs_density",  "ggs_traceplot", "ggs_running", "ggs_compare_partial", "ggs_autocorrelation", "ggs_crosscorrelation", "ggs_Rhat", "ggs_geweke", "ggs_caterpillar"))
```
